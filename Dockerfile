...
RUN mkdir /.npm && chmod -R go+rwx /.npm && chmod -R go+rwx /root && umask 0 && cd /source/openapi-generator && \
    mvn install -Dhttp.proxyHost=172.17.0.1 -Dhttp.proxyPort=7777  -Dhttps.proxyHost=172.17.0.1 -Dhttps.proxyPort=7777  -DskipTests -Dmaven.test.skip=true -pl modules/openapi-generator-maven-plugin -am && \
